create database HemoCare_database; /* creating database*/
use HemoCare_database;
...
values("Avadi,Chennai","xxxxxx@gmail.com","xxxxxxxxx");
...
("Namexxx","xxxxx@gmail.com","xxxxxxxxx","I need____Blood.");
